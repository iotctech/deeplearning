...
### 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-01.jpg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("img/02-02.jpg")
```
...
## AlexNet
### 模型介绍
AlexNet是由_Alex Krizhevsky_提出的首个应用于图像分类的深层卷积神经网络，该网络在2012年ILSVRC（ImageNet Large Scale Visual Recognition Competition）图像分类竞赛中以15.3%的top-5测试错误率赢得第一名。AlexNet使用GPU代替CPU进行运算，使得在可接受的时间范围内模型结构能够更加复杂，它的出现证明了深层卷积神经网络在复杂模型下的有效性，使CNN在计算机视觉中流行开来，直接或间接地引发了深度学习的热潮。

### 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-03.png")
```
...
### 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-04.jpeg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("img/02-05.png")
```

```{r, echo = FALSE}
knitr::include_graphics("img/02-06.png")
```
...
### 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-07.jpeg")
```
...
### 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-08.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("img/02-09.png")
```

### 4.6.2 模型结构
```{r, echo = FALSE}
knitr::include_graphics("img/02-10.jpeg")
```
...
```{r, echo = FALSE}
knitr::include_graphics("img/02-11.png")
```
```{r, echo = FALSE}
knitr::include_graphics("img/02-14.png")
```
```{r, echo = FALSE}
knitr::include_graphics("img/02-12.png")
```
```{r, echo = FALSE}
knitr::include_graphics("img/02-13.png")
```
